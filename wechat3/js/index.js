$(function(){
    ...
    $("#message-icon").click(
        function(){
            ...
            $("#dynamic4").css({"display":"none"})

            $("#title-center").text("微信(206)")
            $("#title-right-plus").css({"display":"block"})
    ...
    $("#me-icon").click(
        function(){
            ...
            $("#dynamic4").css({"display":"flex"})
            // display: ;

            $("#title-center").text("我")
            $("#title-right-plus").css({"display":"none"})
            $("#title-right-menu").css({"display":"none"})
